...
function initCreateSubpackageApp(parseAppOptions2) {
  return function createApp2(vm) {
    ...
    if ({}.UNI_SUBPACKAGE) {
      (swan.$subpackages || (swan.$subpackages = {}))[{}.UNI_SUBPACKAGE] = {
        $vm: vm
      };
    }
  };
...
function parsePropType(type, defaultValue) {
  ...
  {
    if (defaultValue === false && isArray(type) && type.length === 2 && type.indexOf(String) !== -1 && type.indexOf(Boolean) !== -1) {
      return Boolean;
    }
  }
  return type;
...
function getAppVm() {
  ...
  if ({}.UNI_SUBPACKAGE) {
    return swan.$subpackages[{}.UNI_SUBPACKAGE].$vm;
  }
  return getApp().$vm;
}
...
function parse$2(appOptions) {
  appOptions.onShow = function onShow2(args) {
    if (!this.$vm) {
      this.onLaunch(args);
    }
...
function parse(pageOptions) {
  ...
  methods.onShow = function onShow2() {
